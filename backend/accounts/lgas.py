...
# A small mapping of states to Local Government Areas (LGAs).
# Keep this list deliberately small — it can be expanded or moved to the DB later.
STATE_LGAS: Dict[str, List[Dict[str, str]]] = {
    'nasarawa': [
    ...
    'fct': [
        ...
        {'value': 'abuja_municipal', 'label': 'Abuja Municipal'},
    ...
    'oyo': [
        ...
        {'value': 'ibadan_south', 'label': 'Ibadan South'},
        {'value': 'ibadan_east', 'label': 'Ibadan East'},
        {'value': 'ibadan_west', 'label': 'Ibadan West'},
    ],
    'ogun': [
    ...
    'kano': [
        ...
        {'value': 'kano_tarauni', 'label': 'Kano Tarauni'},
        {'value': 'gwale', 'label': 'Gwale'},
    ],

    # Ensure all 36 states + FCT have at least a minimal LGA list (can be expanded later)
    'abia': [
    ...
    'ekiti': [
        ...
        {'value': 'ikere', 'label': 'Ikere-Ekiti'},
        {'value': 'ijero', 'label': 'Ijero-Ekiti'},
        {'value': 'other', 'label': 'Other'},
    ],
    'enugu': [
    ...
    'gombe': [
        ...
        {'value': 'yalmatu_deba', 'label': 'Yalmatu/Deba'},
...
def get_lgas_for_state(state_code: str) -> List[Dict[str, str]]:
    """Return list of LGA dicts for a given state code.

    Returns an empty list when no mapping exists — callers can fallback as needed.
    """
    if not state_code:
        return []
    return STATE_LGAS.get(state_code, [])
